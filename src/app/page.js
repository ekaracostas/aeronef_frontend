...
export default function Home() {
	return (
		<div className="flex-grow max-w-3xl mx-auto px-6 py-12 text-center space-y-6">
			<p className="text-lg md:text-xl">
				Situé en plein Paris, à Ménilmontant, le studio d&apos;enregistrement Aéronef possède un espace en lumière du jour parfaitement adapté à la
